                        ...
                        <div class="logo">
                            <a href="index.html">
                                <img class="logo-light" src="{{ asset('frontend/assets/images/logo/logo.png') }}"
                                    alt="Corporate Logo">
                                <img class="logo-dark" src="{{ asset('frontend/assets/images/logo/logo-dark.png') }}"
                                    alt="Corporate Logo">
                            </a>
                        </div>
                    </div>
                ...
                <div class="header-top">
                    <div class="logo">
                        <a href="index.html">
                            <img class="logo-light" src="{{ asset('frontend/assets/images/logo/logo.png') }}"
                                alt="Corporate Logo">
                            <img class="logo-dark" src="frontend/assets/images/logo/logo-dark.png"
                                alt="Corporate Logo">
                        </a>
                    </div>
                ...
                <ul class="mainmenu">
                    <li class="has-droupdown has-menu-child-item"><a href="#">Home</a>
                        <ul class="submenu">
                            ...
                            <li><a href="index-corporate-one-page.html">Corporate One Page <span
